...
<template>
  <v-app-bar :elevation="0" style="background-color: #f2f3f7" class="px-12">
    ...
    <template v-slot:append>
      <v-btn @click="goToJobs"> jobs </v-btn>
      <v-btn> Companies </v-btn>
      <v-btn> Pricing </v-btn>
      <v-btn> Advice </v-btn>
      <v-btn> Upload </v-btn>
