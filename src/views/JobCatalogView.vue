...
export default {
  ...
  methods: {
    async fetchJobs() {
      try {
        //const jobs = await jobServiceApi.getJobs()
        //this.allJobs = jobs
        this.allJobs = [
          {
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/1755978/disney-streaming-services-squarelogo-1559769078332.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/274004/infinity-consulting-solutions-squarelogo-1431041795684.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/503467/pinterest-squareLogo-1617809885495.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/719287/comcentric-squarelogo-1448025713959.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/2786/fidelity-investments-squareLogo-1612542116323.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/24858/blizzard-entertainment-squareLogo-1625606720830.png',
          ...
          },
          {
            ...
            companyName: 'Cedent',
            companyLogoUrl:
              'https://media.glassdoor.com/sql/1464099/cedent-squarelogo-1582290523558.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/2919/northwestern-mutual-squarelogo-1505752677735.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/1935038/astranis-squarelogo-1522847640036.png',
            locationName: 'San Francisco, CA',
            annualWage: 132118,
            rating: 5,
            payPeriod: 'ANNUAL',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/380907/ping-identity-squarelogo-1464970091149.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/9837/charles-river-laboratories-squarelogo-1463687182149.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/782797/integral-ad-science-squarelogo-1473725099250.png',
            locationName: 'San Francisco, CA',
            annualWage: 160408,
            rating: 3.7,
            payPeriod: 'ANNUAL',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/3306/national-oilwell-varco-squarelogo-1431612939749.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/42406/experian-squarelogo-1594317302472.png',
          ...
          },
          {
            ...
            companyName: 'BDO USA',
            companyLogoUrl:
              'https://media.glassdoor.com/sql/346477/bdo-usa-squarelogo-1481826662725.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/9302/t-mobile-squarelogo-1579812467362.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/2269533/smoothstack-squarelogo-1595881450009.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/321780/ucla-health-system-squarelogo.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/2763/deloitte-squarelogo-1481880537463.png',
          ...
          },
          {
            ...
            companyLogoUrl:
              'https://media.glassdoor.com/sql/3677/mastercard-squarelogo-1468516067022.png',
            locationName: 'New York, NY',
            annualWage: 169896,
            rating: 4.2,
            payPeriod: 'ANNUAL',
